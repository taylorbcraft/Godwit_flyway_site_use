...
#
# inputs
#   - data/last_2_years/site_summary.rds: site points with summary metrics (e.g., prop_mean)
#   - data/last_2_years/loc_sf.rds: site-assigned location fixes (sf)
#
# outputs
#   - figures/last_2_years/core_nonbreeding_sites_map.pdf
# =============================================================================
...
loc_sf <- readRDS("data/last_2_years/loc_sf.rds")
...
ggsave(
  filename = "figures/last_2_years/core_nonbreeding_sites_map.pdf",
  plot = flyway,
  width = w,
  height = h,
  units = "in"
