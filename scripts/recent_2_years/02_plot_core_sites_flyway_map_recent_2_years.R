...
#
# inputs
#   - data/recent_2_years/site_summary_points.rds: site points with summary metrics (e.g., prop_mean)
#   - data/recent_2_years/site_location_fixes.rds: site-assigned location fixes (sf)
#
# outputs
#   - figures/recent_2_years/core_nonbreeding_sites_map.pdf
# =============================================================================
...
ggsave(
  filename = "figures/recent_2_years/core_nonbreeding_sites_map.pdf",
  plot = flyway,
  width = w,
  height = h,
  units = "in"
