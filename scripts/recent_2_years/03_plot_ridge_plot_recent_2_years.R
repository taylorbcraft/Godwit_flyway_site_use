...
#
# Inputs
#   - data/recent_2_years/site_summary_points.rds: site locations (used for ordering sites north to south)
#   - data/recent_2_years/site_presence_days.rds: daily bird presence at sites (one row per bird × site × day)
#
# Output
#   - figures/recent_2_years/ridge_plot.pdf
# =============================================================================
...
# read inputs
# -------------------------------
site_summary_points <- readRDS("data/recent_2_years/site_summary_points.rds")
site_presence_days <- readRDS("data/recent_2_years/site_presence_days.rds")
...
ggsave(
  filename = "figures/recent_2_years/ridge_plot.pdf",
  plot = p_ridge,
  width = 8,
  height = 5,
  units = "in"
